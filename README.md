...
The Smart Campus Library Management System is a modular console-based Java application built using a layered MVC architecture. The system manages a library inventory, tracks student book issuances and returns, enforces borrowing limits and calculates daily overdue fines.
...
-**Fine Calculation:** Automatic calculation of overdue daily fines ($2.00 per day)
